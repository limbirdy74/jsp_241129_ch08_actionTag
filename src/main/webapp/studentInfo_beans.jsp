...
<body>
	...
	학생이름 : <jsp:getProperty property="name" name="studentDto"/><br><br>
	학생나이 : <jsp:getProperty property="age" name="studentDto"/><br><br>
	학생학년 : <jsp:getProperty property="grade" name="studentDto"/><br><br>
	주소 : <jsp:getProperty property="addr" name="studentDto"/><br><br>
